...
public class JurosCompostoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>Resposta: Juros Composto</title>");            
            out.println("</head>");
            
            out.println("<body>");
            out.println("<h1>Resposta: Juros Composto </h1>");
            
            out.println("<section id='resposta' style='font-family: sans-serif'>");
                
                //variaveis
                double capital = 0, taxa=0, simples  = 0, montante = 0, composto = 0;
                int tempo = 0;
                ...
                try{
                    ...
                    composto = montante - capital;
                    
                    out.printf("O montante gerado será de <b>R$ "+df.format(montante)+"</b> e o juros composto aplicado será de <b>R$ "+df.format(composto)+"</b>");
